...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32612',
            //extent: [-16005344.188659, -19739210.084564, 16744002.697784, 19649503.596203],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([73624.894495, 2519780.605460, 765150.472180, 3171648.802345], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_sentinel2_tiles_world_2,
    colName: 'Name',
    zoom: 10,
    collapsed: true,
    map: map,
